...
#Dessa kartor ‰r nog viktigast. Jag undrar om vi kan fÂ rasterfiler fˆr
#2. medelv‰rdet av Log-sannolikheten
#3. summerad Log-sannolikheten
#4. antal arter ˆver 50%-trˆskel delad upp efter 2 grupperingar (group:Environment, group:Salinity) enligt bifogat masterfile (IASmodellng_speciesList)
#
